...
import { instructions, PUBLISHER_MODEL, REPLY_INSTRUCTIONS, REPLY_MAX_LENGTH, REPLY_MODEL, REVIEW_INSTRUCTIONS, REVIEW_REPLY_INSTRUCTIONS, use } from './prompts';

export { use } from './prompts';

export const id = 'bwfish-publisher';
export const title = 'BWFish Publisher';
