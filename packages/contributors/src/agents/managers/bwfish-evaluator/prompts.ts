export const use = `
Scores the platform value of every feed entry. Run on all questions, tips, and corrections after moderation.
...
export const EVALUATE_INSTRUCTIONS = [
	...
	'Use the full range. Small but useful fixes might score 20–40. Solid tips or good questions might score 50–75.',
	'For questions: score higher when the question is specific, on-topic for the page, and likely useful to other anglers.',
	'For tips: score higher when the advice is practical, accurate, and adds real fishing knowledge not already on the page.',
